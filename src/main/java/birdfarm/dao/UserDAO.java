        ...
        try {
            ...
            if (con != null) {
                ...
                if (rs.next()) {
                    ...
                    result = new UserDTO(idUser, username, password,fullName, idRole, image);
        ...
        try {
            ...
            if (con != null) {
                ...
                if (rs.next()) {
                    ...
                    result = new UserDTO(getIdUser, username, password,fullName, idRole,image,phoneNumber,address);
                }//end username and password is verified
            }//end connection is available
        } catch (Exception e) {
            e.printStackTrace();
