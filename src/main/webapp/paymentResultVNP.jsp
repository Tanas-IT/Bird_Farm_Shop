                ...
                <c:if test="${sessionScope.PAYMENT != null}">
                    <c:if test="${not empty sessionScope.PAYMENT}">
                        <table class="table table-striped">
                            <tr>
                                <th>Amount Paid:</th>
                                <td>${sessionScope.PAYMENT.vnp_Amount}</td>
                            </tr>
                            <tr>
                                <th>Order Date:</th>
                                <td>${sessionScope.PAYMENT.vnp_PayDate}</td>
                            </tr>
                            <tr>
                                <th>Order Information:</th>
                                <td>${sessionScope.PAYMENT.vnp_OrderInfo}</td>
                            </tr>
                            <tr>
                                <th>Order Code:</th>
                                <td>${sessionScope.PAYMENT.vnp_TxnRef}</td>
                            </tr>
                            <tr>
                                <th>Bank Code:</th>
                                <td>${sessionScope.PAYMENT.vnp_BankCode}</td>
                            </tr>
                            <tr>
                                <th>Bank Transaction Code:</th>
                                <td>${sessionScope.PAYMENT.vnp_BankTranNo}</td>
                            </tr>
                            <tr>
                                <th>Card Type:</th>
                                <td>${sessionScope.PAYMENT.vnp_CardType}</td>
                            </tr>
                            <tr>
                                <th>VNPay Transaction Code:</th>
                                <td>${sessionScope.PAYMENT.vnp_TransactionNo}</td>
                            </tr>
                            <tr>
                                <th>VNPay Response Code:</th>
                                <td>${sessionScope.PAYMENT.vnp_ResponseCode}</td>
                            </tr>
                            <tr>
                                <th>PAYMENT STATUS</th>
                                <td>${sessionScope.PAYMENT.vnp_Status}</td>
                            </tr>
                        </table>
                    </c:if>
                </c:if>
