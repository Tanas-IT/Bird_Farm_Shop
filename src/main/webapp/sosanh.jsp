                ...
                <thead>
                    <tr class="bg-light">
                        ...
                        <td class="text-center">
                           <img style="max-width: 275px; object-fit: cover; width: 100%; height: 300px; background-size: cover; border-top-left-radius: 3px; border-top-right-radius: 3px" class="card-img-top" src="<%=bird1.getImageURL()%>" alt="<%=bird1.getName()%>" />
                        </td>
                        <td class="text-center ">
                            <img style="max-width: 275px; object-fit: cover;width: 100%; height: 300px; background-size: cover; border-top-left-radius: 3px; border-top-right-radius: 3px" class="card-img-top" src="<%=bird2.getImageURL()%>" alt="<%=bird2.getName()%>" />
                        </td>
                    </tr>
                </thead>
