...
const counterInputs = document.querySelectorAll('.quantityOfBird');
const incrementButtons = document.querySelectorAll('.btn-plus');
const decrementButtons = document.querySelectorAll('.btn-minus');

// Lặp qua tất cả các phần tử và gắn sự kiện cho từng cặp tương ứng
counterInputs.forEach(function (counterInput, index) {
    const initialValue = parseInt(counterInput.value);
    ...
    counterInput.addEventListener('input', function () {
        ...
        // Nếu giá trị nhập vào lớn hơn 5, đặt lại giá trị là 5
        if (currentValue > initialValue) {
            counterInput.value = initialValue;
    ...
    counterInput.addEventListener('blur', function () {
        ...
        // Nếu người dùng không nhập gì, trả về giá trị ban đầu
