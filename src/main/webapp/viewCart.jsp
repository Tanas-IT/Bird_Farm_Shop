        ...
        <div class="container" style="margin-top: 30px">
            ...
            <div class="table-responsive">
                <c:if test="${sessionScope.CART == null}">
                    <h5>Giỏ hàng của bạn đang trống, Hãy nhấn vào nút thêm hàng để thêm hàng vào giỏ</h5>
                    <a href="home.jsp" style="text-decoration: none; color: #198653;">Thêm hàng</a>
                </c:if>
                <c:if test="${sessionScope.CART != null}">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding-top: 40px; text-align: center">
                                            <input type="checkbox" name="idBird" value="${product.value.idBird}"/>
                                        </td>
                                        ...
                                        <td style="padding-top: 40px; text-align: center;">
                                            <input type="number" name="birdQuantity" value="${product.value.quantity}" min="1" style="font-size: 20px; border-radius: 10px; text-align: center; max-width: 100px;"/>
                                        </td>
                                        <td style="padding-top: 40px; text-align: center; font-size: 20px; text-align: center; max-width: 100px;" >
                                            <fmt:formatNumber var="formatFinalEachPrice" value="${product.value.quantity * product.value.salePrice}"  />
                                        ...
                                        <div class="container" style="margin-top: 20px;">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6" style="text-align: right; display: flex;align-items: end;justify-content: end;margin-bottom: 24px;transform: translateY(-24px);">
                                                    ...
                                                    <c:url var="checkOutLink" value="DispatchServlet">
                                                        <c:param name="userID" value="<%= user.getIdUser()%>" />
                                                        <c:param name="btAction" value="CheckOut"></c:param>
                                                        <c:param name="total" value="${sessionScope.total}"></c:param>
                                                    </c:url>
                                                    <a href="${checkOutLink}" class="d-inline btn btn-success btn-lg" style="margin-left: 10px; margin-top: 20px;" >Thanh toán</a>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
