                            ...
                            <div class="product-actions justify-content-between card-footer p-4 pb-2 pt-0 border-top-0 bg-transparent">
                                <div class="btn-add">
                                    <form action="DispatchServlet">
                                        ...
                                        <input type="hidden" name="selectedItem" value="<%= birdPremium.getIdBird()%>"/>
                                ...
                                <div class="btn-add">
                                    <form action="DispatchServlet">
                                        ...
                                        <input type="hidden" name="birdQuantity" value="1" />
                                         <input type="hidden" name="selectedItem" value="<%= birdNest.getIdBird()%>"/>
                                        <input type="submit" name="btAction" value = "Mua ngay" class="btn-addCart btn-item btn btn-outline-dark mt-auto"/>
                                    </form>
                                </div>
                            ...
                            <div class="product-actions justify-content-between card-footer p-4 pb-2 pt-0 border-top-0 bg-transparent">
                                <div class="btn-add">
                                    <form action="DispatchServlet">
                                        ...
                                        <input type="hidden" name="birdQuantity" value="1" />
                                        <input type="hidden" name="selectedItem" value="<%= birdsInLots.getIdBird()%>"/>
                                        <input type="submit" name="btAction" value = "Mua ngay" class="btn-addCart btn-item btn btn-outline-dark mt-auto"/>
                                    </form>
                                </div>
                            ...
                            <div class="product-actions justify-content-between card-footer p-4 pb-2 pt-0 border-top-0 bg-transparent">
                                <div class="btn-add">
                                    <form action="DispatchServlet">
                                        ...
                                        <input type="hidden" name="birdQuantity" value="1" />
                                        <input type="hidden" name="selectedItem" value="<%= birdBestSeller.getIdBird()%>"/>
                                        <input type="submit" name="btAction" value = "Mua ngay" class="btn-addCart btn-item btn btn-outline-dark mt-auto"/>
                                    </form>
                                </div>
