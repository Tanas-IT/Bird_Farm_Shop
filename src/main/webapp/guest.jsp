...
<!--                            <span class="input-group-append">
        ...
        <section id="content" class="py-5">
            <div style="max-width: 1920px !important; padding-left: 3.5rem !important" class="container px-4 w-100">
                <div style="display: flex; justify-content: space-between">
                    <h2 id="birdPremium" class="title-category text-danger">Chim Cao Cấp</h2>
                ...
                <div style="display: flex; justify-content: space-between">
                    <h2 id="birdNest" class="title-category text-danger">Tổ Chim</h2>
                ...
                <div style="display: flex; justify-content: space-between">
                    <h2 id="birdLots" class="title-category text-danger">Chim Phổ Thông</h2>
        ...
        <section class="py-5 text-black">
            <div style="background-color: #f3f3f3;">
                <div class="pt-3 d-flex align-items-center text-danger justify-content-center fs-1 section-title">
