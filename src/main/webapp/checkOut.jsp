...
<body>
    ...
    <div class="container" style="max-width: 1400px;">
        <div class="table-responsive">
            <c:if test="${sessionScope.CHECKOUTCART != null}">
                <c:if test="${not empty sessionScope.CHECKOUTCART}">
                    ...
                    <table style="margin-top: 12%" class="table table-striped">
                        ...
                        <tbody>
                            <c:forEach var="product" varStatus="counter" items="${sessionScope.CHECKOUTCART.cart}">
                                <c:set scope="request" var="total" value="${requestScope.total + product.value.quantityOfUser * product.value.salePrice}"></c:set>
                                    <tr>
                                    ...
                                    <td style="padding-top: 40px; text-align: center;">
                                        ...
                                        <input style="border: none; background-color: transparent; text-align: center;" readonly="true" type="text" name="idBird" value="${type}"/>
                                    </td>
                                    <td style="padding-top: 40px; text-align: center;">
                                    ...
                                    <td style="padding-top: 40px; text-align: center;">
                                        <input type="number" name="quantity" value="${product.value.quantityOfUser}" min="1" readonly="" style="border: none; background: none; font-size: 20px; text-align: center;"/>
                                    </td>
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                ...
                                <div class="col-10">
                                    ...
                                    <input disabled="true" id="email" type="email" name="email" value="${user.email}"required="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" style="width: 100%; margin-bottom: 10px; border: none; border-bottom: 2px solid black;"/><br>
                ...
                <div class="col-5">
                    <div style="background-color: rgb(255, 249, 158); padding: 20px 30px; border-radius: 15px; box-shadow: 0 3px 10px rgb(0 0 0 /0.5) inset;">
                        ...
                        <h2 style="text-align: center; padding: 20px 0px; color: red;">
                            <fmt:formatNumber var="formatTotalPrice" value="${requestScope.total}"  />
                        ...
                        <div style="text-align: center;">
                            ...
                            <input type="submit" name="btAction" value="Thanh toán" class="btn btn-success btn-lg"/>
                        </div>
                    </div>
                </div>
             </div>
